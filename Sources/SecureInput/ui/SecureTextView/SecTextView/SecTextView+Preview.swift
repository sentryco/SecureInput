...
#Preview(traits: .fixedLayout(width: 400, height: 300)) {
    ...
    */
   @Previewable @State var visibleInput1: String = SecRan.randomSecret() ?? "xyz123" // "abc123\n123abc" // temp storage
   // @State var visibleInput2: String = "abc123\n123abc"
   @Previewable @State var isSecure: Bool = false // Indicates whether the text in SecTextView should be obscured.
   PreviewContainer {
